...
from nets.nn_v8 import YOLODetector
...
class Search(CMP):
    def __init__(self, config):
        ...
        if self.use_yolo_gcn:
            ...
            # ---------- 加载本地权重 ----------
            yolo_weight_path = config.get('yolo_weight_path', 'weights/v8_x.pt')
    ...
    def detect_persons_and_extract_features(self, image, save_dir="debug_vis"):
        ...
        feature_map = yolo_feature_maps[2]  # 选择中间尺度的特征图
